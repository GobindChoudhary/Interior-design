...
const successStoriesData = [
  ...
  },
  {
    id: 3,
    title:
      "Utilitarian and Comfortable, This Mumbai Home Is All About Thoughtfully Designed Spaces",
    category: "Interior Design",
    image: bedroomImg,
  },
  {
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-[28px] md:text-[36px] font-bold text-[#212529] mb-4">
            From Vision to Reality: Home Interior Success Stories
          </h2>
          <p className="text-[#7b7b7b] text-[16px] md:text-[18px] leading-relaxed">
            Join us on a journey through the homes we've transformed. From the
            first design meeting to the final reveal, see how we bring each
            homeowner's unique vision to life. Get inspired by real stories and
            discover what makes a HomeLane home truly special!
          </p>
        </div>
          ...
          >
            {successStoriesData.map((story) => (
              <div
                ...
                className="flex-none w-[300px] md:w-[350px] lg:w-[400px] aspect-[4/5] md:aspect-square relative rounded-xl overflow-hidden group/card cursor-pointer snap-start shadow-sm border border-[#f0f0f0] hover:shadow-xl transition-shadow duration-300"
              >
                {/* Background Image */}
                <img
                  src={story.image}
