    ...
    },
    {
        ...
        icon: (
            ...
            >
                ...
                <rect x="4" y="5" width="7" height="6" rx="0.5" stroke="#e0b855" />
                <rect x="13" y="5" width="7" height="6" rx="0.5" stroke="#e0b855" />
            </svg>
        ),
    },
    {
        ...
        icon: (
            ...
            >
                ...
                <rect x="6" y="10" width="4" height="3" rx="0.5" stroke="#e0b855" />
                <rect x="14" y="10" width="4" height="3" rx="0.5" stroke="#e0b855" />
            </svg>
        ),
    },
    {
        ...
        icon: (
            ...
            >
                ...
                <rect x="7" y="10" width="4" height="3" rx="0.5" stroke="#e0b855" />
                <rect x="13" y="10" width="4" height="3" rx="0.5" stroke="#e0b855" />
            </svg>
        ),
    },
    {
    ...
    },
    {
        ...
        icon: (
            ...
            >
                ...
                <rect x="6" y="4" width="12" height="7" rx="0.5" stroke="#e0b855" />
                <path d="M10 11v3h4v-3" stroke="#e0b855" />
            </svg>
        ),
    },
    {
        ...
        icon: (
            ...
            >
                ...
                <path
                    ...
                    strokeLinecap="round"
                />
                <circle cx="12" cy="4" r="1.5" fill="#e0b855" />
            </svg>
        ),
    },
];
...
export const offeringsLinks = [
    {
        ...
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <path d="M9 21V12h6v9" stroke="#e0b855" />
            </svg>
        )
    }
];
