...
export const livingRoomDesigns = [
  { id: 1, title: "Teal Treasures Living Room Design", images: [img1, img2, img3] },
  { id: 3, title: "Sylvan Oasis Balcony Design", images: [img4, img5, img6] },
  { id: 4, title: "Bohemian Jungle Living Room Design", images: [img7, img8, img1] },
  { id: 5, title: "Urban Sunshine Living Room Design", images: [img2, img3, img4] },
  { id: 6, title: "Mediterranean Escape Living Room Design", images: [img5, img6, img7] }
];

export const livingRoomTestimonials = [
  { id: 1, img: test1, quote: "I highly recommend to everyone—if you're looking for wooden work, go to HomeLane.", names: "Prateek and Aastha's Home", location: "Pioneer Presidia, Gurugram" },
  { id: 2, img: test2, quote: "As an actor-influencer, getting a photoshoot-ready home was very easy with HomeLane.", names: "Karishma Sharma's Home", location: "Lashkaria Empress, Mumbai" },
  { id: 3, img: test3, quote: "Our first 2BHK was with HomeLane. When we bought this house, HomeLane came to mind again.", names: "Anupam and Archana's Home", location: "Prestige Lakeside Habitat, Bangalore" },
  { id: 4, img: test4, quote: "The personalized design process and attention to our needs made all the difference.", names: "Sameer and Sneha's Home", location: "Lodha Amara, Thane" }
];
...
export const galleryDataMap = {
  'modular-kitchen': {
    ...
    designs: [
      { id: 1, title: "Sleek Minimalist L-Shaped Kitchen", images: [img1, img3, img5] },
      { id: 2, title: "Elegant Luxurious Beige Kitchen", images: [img2, img4, img6] },
