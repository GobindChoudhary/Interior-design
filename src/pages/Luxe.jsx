...
import heroImg from '../assets/imgi_1_best-home-interior-design-solutions-homelane-new.avif';
        ...
        <div className="bg-white font-sans text-[#1A1A1A] pt-[70px]">
            ...
            <section className="relative h-[85vh] min-h-[600px] flex items-center bg-white overflow-hidden">
                <div className="absolute inset-0 w-full h-full">
                    <img src={heroImg} alt="Luxe Interior" className="w-full h-full object-cover object-center" />
                </div>

                <div className="relative z-10 w-full max-w-[1240px] mx-auto px-6 h-full flex justify-end items-center">
                    {/* Form aligned to right */}
                    <form className="bg-[#FAF9F5] p-10 rounded-[4px] shadow-2xl max-w-[420px] w-full border border-gray-100">
                        <h3 className="text-[30px] font-serif mb-6 text-[#1A1A1A] font-light">
                            Meet a <span className="font-script text-[48px] lowercase tracking-wide italic leading-[0]">designer</span>
                        </h3>
                        <div className="space-y-6">
                            <input type="text" placeholder="Enter your name" className="w-full border-b border-gray-300 bg-transparent py-2 focus:outline-none focus:border-[#8B6E30] transition-colors text-[14px]" />
                            <div className="flex border-b border-gray-300 focus-within:border-[#8B6E30] transition-colors items-center">
                                ...
                                <input type="tel" placeholder="Enter your mobile number" className="w-full bg-transparent py-2 px-3 focus:outline-none text-[14px]" />
                            </div>
                            <div className="flex items-center justify-between py-2 border-b border-gray-300">
                                <span className="text-[13px] text-gray-600">Send me updates on WhatsApp</span>
                                <div className="w-10 h-6 bg-[#9B7B26] rounded-full relative cursor-pointer">
                                    <div className="w-4 h-4 bg-white rounded-full absolute right-1 top-[4px]"></div>
                                </div>
                            </div>
                            <div className="relative border-b border-gray-300 py-2">
                                <select className="w-full bg-transparent pr-4 focus:outline-none text-[14px] text-gray-500 appearance-none cursor-pointer">
                                    <option value="">Select your property city</option>
                                    <option value="bangalore">Bengaluru</option>
                                    <option value="mumbai">Mumbai</option>
                                    <option value="delhi">Delhi</option>
                                </select>
                                <span className="absolute right-0 top-1/2 -translate-y-1/2 text-[10px] text-gray-500 pointer-events-none">▼</span>
                            </div>

                            <button type="submit" className="w-full bg-[#9B7B26] hover:bg-[#8B6E30] text-white font-semibold py-4 px-4 rounded-[4px] transition-colors tracking-widest text-[13px] mt-8 shadow-md">
                                SCHEDULE NOW
                            </button>
                            <p className="text-[10px] text-gray-500 leading-relaxed mt-4 text-left">
                                By submitting, you agree to our <a href="#" className="text-gray-700 hover:underline">privacy policy</a> and <a href="#" className="text-gray-700 hover:underline">terms of use</a>, allowing us to use your information as outlined.
                            </p>
                        </div>
                    </form>
                </div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-[1100px] mx-auto px-6 text-center">
                    <h2 className="text-[38px] font-serif mb-24 text-[#1A1A1A] font-light">
                        Why HomeLane <span className="font-script text-[#4A4A4A] text-[70px] italic lowercase inline-block translate-y-4 leading-[0.5]">luxe</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-[28px] font-serif mb-3 text-[#1A1A1A] font-light">Exclusive<br />Catalogue</h3>
                            <p className="text-[#9B7B26] text-[15px] font-light leading-relaxed max-w-[220px]">
                                300+ designs,<br />materials, and finishes
                            </p>
                        </div>
                        {/* Box 2 */}
                        <div className="flex flex-col items-center">
                            <div className="text-[#9B7B26] mb-8">
                                <svg width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <polygon points="12 1 12.8 2.5 14.2 2.8 13.1 3.9 13.3 5.4 12 4.7 10.7 5.4 10.9 3.9 9.8 2.8 11.2 2.5 12 1" fill="currentColor" />
                                </svg>
                            </div>
                            <h3 className="text-[28px] font-serif mb-3 text-[#1A1A1A] font-light">All Star<br />Designers</h3>
                            <p className="text-[#9B7B26] text-[15px] font-light leading-relaxed max-w-[220px]">
                                100+ premium homes<br />designed
                            </p>
                        </div>
                        {/* Box 3 */}
                        <div className="flex flex-col items-center">
                            <div className="text-[#9B7B26] mb-8">
                                <svg width="84" height="70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                                    {/* Project Managers outline */}
                                    <circle cx="12" cy="7" r="2" />
                                    <path d="M12 11c-2.2 0-4 1.8-4 4v5h8v-5c0-2.2-1.8-4-4-4z" />
                                    <circle cx="18" cy="9" r="2" />
                                    <path d="M18 13c-2.2 0-4 1.8-4 4v4h8v-4c0-2.2-1.8-4-4-4z" opacity="0.6" />
                                    <circle cx="6" cy="9" r="2" />
                                    <path d="M6 13c-2.2 0-4 1.8-4 4v4h8v-4c0-2.2-1.8-4-4-4z" opacity="0.6" />
                                </svg>
                            </div>
                            <h3 className="text-[28px] font-serif mb-3 text-[#1A1A1A] font-light">Experienced<br />Project Managers</h3>
                            <p className="text-[#9B7B26] text-[15px] font-light leading-relaxed max-w-[220px]">
                                25+ high end homes<br />executed to perfection
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-start justify-between gap-16 relative">
                        ...
                        <div className="flex-[0.8] lg:sticky lg:top-32 text-center lg:text-left z-20">
                            <h2 className="text-[44px] font-serif text-[#1A1A1A] font-light leading-tight">
                                HomeLane Luxe
                                <br />
                                <span className="font-script text-[#4A4A4A] text-[85px] lowercase tracking-normal pl-8 block mt-[-20px] italic leading-[0.5]">journey</span>
                            </h2>
                            <button className="mt-20 bg-[#9B7B26] hover:bg-[#8B6E30] text-white font-semibold py-4 px-10 rounded-[4px] tracking-widest text-[14px] transition-colors shadow-lg shadow-[#8B6E30]/20">
                                MEET A DESIGNER
                            </button>
                        </div>
                        ...
                        <div className="flex-[1.2] w-full flex flex-col gap-0 relative pt-8">
                            {[
                                { step: "Step 1", title: "Meet Your Designer", desc: "Share your ideas and floor plan to receive personalised 3D designs and an instant quote.", icon: "handshake" },
                                { step: "Step 2", title: "The HomeLane Luxe Membership", desc: "Become a member for ₹25K. Get unique design themes and mood boards crafted exclusively for you.", icon: "hexagon" },
                                { step: "Step 3", title: "Book Your Order", desc: "Pay 10% of the woodwork and home decor services to book your order.", icon: "book" },
                                { step: "Step 4", title: "Finalise Your Design", desc: "Choose your materials, finishes and colours. Pay the next 10% of woodwork and home decor services to lock designs and begin site masking and quality checks.", icon: "blueprint" },
                                { step: "Step 5", title: "Send Designs to Factory", desc: "Pay 30% of woodwork and 80% of home decor services to begin factory production.", icon: "pencil" },
                                { step: "Step 6", title: "Kick Off Dispatch", desc: "Pay the remaining 50% of woodwork to dispatch your order post-production and begin installation.", icon: "truck" },
                                { step: "Step 7", title: "Complete Installation & Handover", desc: "Our team installs, completes final checks and hands over your home for a smooth move-in.", icon: "tools" }
                            ].map((card, idx) => (
                                <div
                                    key={idx}
                                ...
                                >
                                    ...
                                    <div className="text-[#9B7B26] mb-4">
                                        {card.icon === 'handshake' && (
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="m11 17 2 2a1 1 0 1 0 3-3" /><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4" /><path d="m21 3-6 6" /><path d="m21 17-6-6" /><path d="m21 21-6-6" /><path d="M5 21a1 1 0 1 1-2 0V11a1 1 0 1 1 2 0z" /></svg>
                                        )}
                                        {card.icon === 'hexagon' && (
                                        ...
                                        {card.icon === 'blueprint' && (
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><path d="M9 3v18" /><path d="M15 3v18" /><path d="M3 9h18" /><path d="M3 15h18" /></svg>
                                        )}
                                        {card.icon === 'pencil' && (
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
                                        )}
                                        {card.icon === 'truck' && (
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /><path d="M7 11h10" /><path d="M7 7h10" /></svg>
                                        )}
                                        {card.icon === 'tools' && (
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M18.3 5.7a3.02 3.02 0 0 0-4.2.2l-9.9 9.9a2.08 2.08 0 0 0-0.4 1.4v2.8h2.8a2.08 2.08 0 0 0 1.4-0.4l9.9-9.9a3.02 3.02 0 0 0 .2-4.2Zm-1.4 1.4 2 2M15 8l2 2" /></svg>
                                        )}
                                    </div>
                                    <h4 className="text-[26px] font-sans font-light text-[#1A1A1A] mb-3">{card.title}</h4>
            ...
            <section className="py-24 bg-[#FAF9F5]">
                <div className="max-w-[1240px] mx-auto px-6 text-center">
                    <h2 className="text-[40px] font-serif mb-16 text-[#1A1A1A] font-light">
                        HomeLane Luxe <span className="font-script text-[#4A4A4A] text-[75px] lowercase italic leading-[0.5] ml-2">offerings</span>
                    </h2>

                    {/* Desktop Carousel Layout representation */}
                    <div className="flex items-center justify-between">
                        <button className="hidden md:flex w-10 h-10 items-center justify-center text-[#9B7B26] hover:bg-white rounded-full transition-colors">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M15 18l-6-6 6-6" /></svg>
                        </button>

                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 flex-1 px-4 lg:px-8">
                            {[
                                ...
                                <div key={idx} className="group cursor-pointer">
                                    ...
                                    <h4 className="text-[16px] text-gray-600 font-light">{item.title}</h4>
                                </div>
                            ))}
                        </div>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 h-full flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-right">
                        <h2 className="text-[48px] font-script text-[#4A4A4A] italic lowercase leading-[0.5]">from our</h2>
                        <h3 className="text-[52px] font-sans font-light text-[#1A1A1A] tracking-wide mt-2">Clients</h3>
                    </div>
                    ...
                    <div className="flex-[1.5] flex items-center gap-6 w-full relative">
                        ...
                        <div className="bg-white rounded-[4px] p-10 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100 w-full relative">
                            <h4 className="text-[18px] font-bold text-[#4A4A4A] tracking-wider mb-8">KARISHMA SHARMA</h4>

                            <div className="relative aspect-video w-[80%] mb-6 rounded-[4px] overflow-hidden group cursor-pointer shadow-sm">
                                <img src={clientImg} alt="Client Review" className="w-full h-full object-cover" />
                            ...
                            <p className="text-[12px] text-gray-400 mb-4 font-sans">Laksharia Empress, Mumbai</p>
                            <p className="text-[14px] text-gray-600 font-light leading-relaxed max-w-[85%] italic">
                                "Nailed it! Interiors, lights, aesthetics—all on point. Being an actor and influencer, a camera-ready aesthetic home is a must. They got my vibe and delivered incredible interiors at reasonable prices!"
                            </p>
                        </div>
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 text-center">
                    <h2 className="text-[44px] font-script text-[#4A4A4A] italic lowercase leading-[0.5] mb-2">spaces <span className="font-sans text-[36px] font-light text-[#1A1A1A] not-italic tracking-wide">by HomeLane Luxe</span></h2>

                    <div className="flex justify-center gap-8 md:gap-12 mb-16 mt-16 overflow-x-auto whitespace-nowrap px-4 hide-scrollbar">
                        {['Art Deco', 'Eclectic', 'Indian Revival', 'Japandi', 'Memphis', 'Rustic'].map((tab, idx) => (
                            <button key={idx} className={`text-[16px] font-sans transition-colors ${idx === 0 ? 'text-[#9B7B26] font-medium' : 'text-gray-500 hover:text-gray-900 font-light'}`}>
                                {tab}
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="rounded-[8px] overflow-hidden aspect-[4/3] group cursor-pointer shadow-sm">
                            <img src={spArtDeco} alt="Art Deco Space" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out" />
                        </div>
                        <div className="rounded-[8px] overflow-hidden aspect-[4/3] group cursor-pointer shadow-sm">
                            <img src={spEclectic} alt="Eclectic Space" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-[#4A4D4A]">
                <div className="max-w-[1100px] mx-auto px-6 text-center">
                    <h2 className="text-[32px] font-sans font-light text-white mb-20 tracking-wide">
                        Our Incredible <span className="font-script text-[64px] italic lowercase leading-[0.5] ml-2 font-normal">partners</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-y-16 gap-x-8 items-center justify-items-center">
                        {[
                            ...
                            <div key={idx} className="flex items-center justify-center w-full max-w-[160px]">
                                <img src={partner.img} alt={partner.name} className={`${partner.h} object-contain filter brightness-0 invert opacity-90 hover:opacity-100 transition-opacity`} />
                            </div>
                        ))}
                    </div>
                </div>
