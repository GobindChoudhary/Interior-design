...
const communityLogos = [futuraLogo, frankeLogo, jaquarLogo, ruheLogo, philipsLogo, wiproLogo];
    ...
    return (
        <div className="w-full bg-white font-sans text-[#212529]">
                ...
                <div className="relative z-10 max-w-[1400px] mx-auto px-6 w-full text-white">
                    <div className="max-w-2xl">
                        <h1 className="text-[40px] md:text-[56px] font-bold mb-10 leading-tight">
                            Best Home Interior <br />Designers in {displayCity}
                        </h1>
                        ...
                        <button className="bg-[#e71c24] hover:bg-[#c41920] text-white font-bold py-4 px-8 rounded flex items-center gap-3 transition-colors text-[16px]">
            ...
            <div className="max-w-[1400px] mx-auto px-6 py-4 text-[13px] text-gray-500 border-b border-gray-100">
                <Link to="/" className="text-[#e71c24] hover:underline">Home</Link> / <Link to="/cities" className="text-[#e71c24] hover:underline">All Cities</Link> / Interior Designers In {displayCity}
            </div>
            ...
            <section className="py-20 text-center max-w-[1400px] mx-auto px-6">
                ...
                <p className="text-[#4a4a4a] max-w-5xl mx-auto text-[16px] leading-relax mb-16">
                    Looking for the perfect home interior in {displayCity}? HomeLane's talented interior designers in {displayCity} will breathe life into your décor dreams! We're passionate about crafting extraordinary homes with spaces that come alive with your personality. We've got the best interior designers in {displayCity} who love what they do, bringing both heart and skill to every project. Let's talk.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                    {[
                        { id: 1, title: 'Modular Kitchen Designs', img: kitchenImg, colSpan: 'col-span-1 md:col-span-2' },
                        { id: 2, title: 'Bedroom Designs', img: bedroomImg, colSpan: 'col-span-1' },
                        { id: 3, title: 'Wardrobe Designs', img: wardrobeImg, colSpan: 'col-span-1 md:col-span-2' },
                        { id: 4, title: 'Living Room Designs', img: livingImg, colSpan: 'col-span-1' },
                    ].map(item => (
                        <div key={item.id} className={`group relative rounded-xl overflow-hidden cursor-pointer shadow-sm border border-gray-100 h-[300px] ${item.colSpan}`}>
                            <img src={item.img} alt={item.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                            <div className="absolute bottom-0 left-0 bg-white p-4 pl-6 pr-12 rounded-tr-3xl">
                                <h3 className="text-[18px] font-medium text-[#212529]">{item.title}</h3>
                ...
                <div className="max-w-[1200px] mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-[18px] text-[#4a4a4a] font-medium">Delivery in 45 days*</p>
                        </div>
                        {/* 2 */}
                        <div className="flex flex-col items-center">
                            <div className="w-24 h-24 mb-6 flex items-center justify-center border-2 border-[#212529] rounded-2xl relative bg-white rounded-t-full">
                                <span className="text-3xl text-white bg-[#e71c24] rounded-full w-12 h-12 flex justify-center items-center">₹</span>
                            </div>
                            <p className="text-[18px] text-[#4a4a4a] font-medium">No hidden costs</p>
                        </div>
                        {/* 3 */}
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-[18px] text-[#4a4a4a] font-medium">Flat 10-year warranty</p>
                        </div>
                        {/* 4 */}
                        <div className="flex flex-col items-center">
                            <div className="w-24 h-24 mb-6 flex items-center justify-center border-2 border-[#212529] rounded-xl relative bg-white p-2">
                                <div className="grid grid-cols-3 gap-1 w-full h-full">
                                    ...
                                    <div className="border border-[#212529]"></div><div className="border border-[#212529]"></div><div className="border border-[#212529]"></div>
                                    <div className="border border-[#212529]"></div><div className="border border-[#212529]"></div><div className="border border-[#212529]"></div>
                                </div>
                            ...
                            <p className="text-[18px] text-[#4a4a4a] font-medium">Easy EMIs</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 max-w-[1400px] mx-auto px-6 text-center">
                <h2 className="text-[32px] md:text-[38px] font-medium mb-4 text-[#212529]">55000+ Homes Delivered</h2>
                <p className="text-[#4a4a4a] max-w-4xl mx-auto text-[16px] leading-relaxed mb-12">
                    At HomeLane, we believe every home has a story to tell. We take pride in transforming spaces across the country into homes filled with character and charm. Have a look at the interiors we've crafted in some of the most prestigious locales in different cities.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {[
                        ...
                        <div key={idx} className="relative rounded-2xl overflow-hidden h-[450px]">
                            <img src={item.src} className="w-full h-full object-cover" alt={item.label} />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                            <span className="absolute bottom-6 left-6 text-white text-xl font-medium">{item.label}</span>
                        </div>
                    ))}
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col h-full">
                            <div className="rounded-xl overflow-hidden mb-6 h-[240px]">
                                <img src={livingImg} alt="Full Home Interior" className="w-full h-full object-cover" />
                            </div>
                            <h3 className="text-[22px] font-medium text-[#212529] mb-2">Full Home Interior Cost in {displayCity}</h3>
                            <p className="text-[#4a4a4a] text-[15px] mb-6 flex-grow">Get a price estimate for your full home interiors.</p>
                            <button className="bg-[#e71c24] hover:bg-[#c41920] text-white font-bold py-3 px-6 rounded text-[15px] w-max transition-colors">
                                Get Free Estimate
                            </button>
                        </div>
                        {/* Modular Kitchen */}
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col h-full">
                            <div className="rounded-xl overflow-hidden mb-6 h-[240px]">
                                <img src={kitchenImg} alt="Modular Kitchen" className="w-full h-full object-cover" />
                            </div>
                            <h3 className="text-[22px] font-medium text-[#212529] mb-2">Modular Kitchen Cost in {displayCity}</h3>
                            <p className="text-[#4a4a4a] text-[15px] mb-6 flex-grow">Get costing for your kitchen interiors.</p>
                            <button className="bg-[#e71c24] hover:bg-[#c41920] text-white font-bold py-3 px-6 rounded text-[15px] w-max transition-colors">
                                Get Free Estimate
                            </button>
                        </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-[1200px] mx-auto px-6 text-center">
                    ...
                    <p className="text-[#4a4a4a] max-w-3xl mx-auto text-[16px] mb-12 leading-relaxed">
                        From iconic skyscrapers to cosy apartment complexes, we've designed homes in some of the most notable neighbourhoods across the country.
                    </p>

                    {/* Mocking the communities using partner logos */}
                    <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
                        {communityLogos.map((logo, idx) => (
                            <div key={idx} className="w-[180px] h-[90px] rounded-xl border border-gray-200 flex items-center justify-center p-4 hover:shadow-md transition-shadow">
                                <img src={logo} alt="Community Logo" className="max-w-full max-h-full object-contain filter grayscale hover:grayscale-0 transition-all opacity-80" />
                            </div>
                        ))}
                        {/* Duplicating just to fill out the grid similar to the reference image */}
                        {communityLogos.slice(0, 4).map((logo, idx) => (
                            <div key={`dup-${idx}`} className="w-[180px] h-[90px] rounded-xl border border-gray-200 flex items-center justify-center p-4 hover:shadow-md transition-shadow">
                                <img src={logo} alt="Community Logo" className="max-w-full max-h-full object-contain filter grayscale hover:grayscale-0 transition-all opacity-80" />
                            </div>
                        ))}
                    </div>
            ...
            {/* 8. EXPERT DESIGNERS */}
            <ExpertDesigners title="600+ Expert Home Interior Designers" subtitle="" />
            ...
            <section className="py-20 bg-white border-t border-gray-100">
                <div className="max-w-[1200px] mx-auto px-6 text-center">
                    ...
                    <div className="flex justify-center gap-4 mb-10">
                        <button className="px-6 py-2 rounded-full border border-gray-300 text-[#4a4a4a] hover:border-[#e71c24] hover:text-[#e71c24] transition-colors">
                            City Center
                        </button>
                        <button className="px-6 py-2 rounded-full border border-[#e71c24] text-[#e71c24] font-medium">
                            North Wing
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row border border-gray-200 rounded-xl overflow-hidden text-left shadow-sm">
                        <div className="w-full md:w-[45%] h-[300px] md:h-auto">
                            <img src={kitchenImg} alt={`${displayCity} Experience Centre`} className="w-full h-full object-cover" />
                        </div>
                        <div className="w-full md:w-[55%] p-8 md:p-10 bg-white flex flex-col justify-center">
                            <p className="text-[12px] font-bold text-[#e71c24] tracking-widest mb-2 uppercase">ADDRESS</p>
                            <p className="text-[16px] text-[#4a4a4a] leading-relaxed mb-6 font-medium">
                                HomeLane {displayCity} North Wing - Shop no. 240, 2nd Floor, The CBD Shopping Center, Between Main Circle and Ring Road, {displayCity}, 382421
                            </p>

                            <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-4">
                                <button className="text-[14px] text-[#1a5bc5] font-medium hover:underline">View Direction</button>
                                <button className="text-[14px] text-[#1a5bc5] font-medium hover:underline">Explore</button>
                            </div>

                            <div className="grid grid-cols-2 gap-8 mb-8">
                                <div>
                                    <p className="text-[12px] text-[#7b7b7b] uppercase tracking-wider mb-1">TIMINGS</p>
                                    <p className="text-[15px] text-[#212529] font-medium">Monday To Sunday | 11am to 8pm</p>
                                </div>
                                <div>
                                    <p className="text-[12px] text-[#7b7b7b] uppercase tracking-wider mb-1">CONTACT NUMBER</p>
                                    <p className="text-[15px] text-[#212529] font-medium">18001024663</p>
                                </div>
                            </div>

                            <div className="mb-8">
                                <p className="text-[12px] text-[#7b7b7b] uppercase tracking-wider mb-1">FACILITIES FOR YOUR CONVENIENCE:</p>
                                <p className="text-[15px] text-[#4a4a4a]">Free Car Parking | Restrooms</p>
                            </div>

                            <div className="mb-10">
                                <p className="text-[12px] text-[#7b7b7b] uppercase tracking-wider mb-1">WHAT TO BRING FOR YOUR DESIGN CONSULTATION:</p>
                                <p className="text-[15px] text-[#4a4a4a]">Floor Plan | Site Images</p>
                            </div>

                            <div className="text-center md:text-left">
                                <button className="border-2 border-[#e71c24] text-[#e71c24] hover:bg-[#e71c24] hover:text-white font-bold py-3 px-10 rounded transition-colors text-[16px]">
                                    Schedule Visit
                                </button>
                            </div>
                        </div>
            ...
            {/* 11. FAQ */}
            <FAQ items={faqItems} title={`Frequently Asked Questions about Home Interiors in ${displayCity}`} />
